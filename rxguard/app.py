...
def astaken_view(data):
    ...
    stale_n = mark_gut_stale(findings, data)
...
def stack_findings(keys, conditions, unlisted, dosed=None):
...
.unresolved{border-left:3px solid var(--red)}
...
def create_app(db_path=None, secret=None):
    ...
    def episode():
        ...
        <input type="text" name="drugs" value="{{ raw }}" autofocus
          placeholder="one or more drug names, comma separated">
    ...
    def profile():
        ...
        <label>Add a constraint</label><input type="text" name="text"
          placeholder="a durable finding, its year, and the drug reaction it constrains">
    ...
    def astaken():
        ...
        {% endif %}
        <p class="muted">Absence of a flag means nothing was found in this knowledge base, not
    ...
    def api_feed_status():
        ...
        # RXGUARD_V170_HONEST -- red/amber are the as-taken counts, so GutLog's
