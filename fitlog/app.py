...
def _watch_day(conn, d):
    ...
    # FITLOG_SLEEP_P2_PAGE. The whole night, not just its total, so the
...
W_DAILY = (
    ...
    # FITLOG_SLEEP_P2_PAGE. Named for what they are. The Watch derives both
...
# ---------------- the sleep record (FITLOG_SLEEP_P2_PAGE) ----------------
